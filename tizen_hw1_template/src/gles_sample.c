...
list_item_select_cb(void* data, Evas_Object* obj, void* event_info)
{
	...
	elm_naviframe_item_push(ad->navi, "ComputerGraphicsHW1", NULL, NULL, view, NULL);
}
...
app_create(void* data)
{
	...
	Elm_Object_Item* navi_item = elm_naviframe_item_push(ad->navi, "ComputerGraphicsHW1", NULL, NULL, main_list, NULL);
